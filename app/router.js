module.exports = app => {
  ...
  router.get(
    '/address/:address/orc20-balance/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.orc20TokenBalance
  )
  router.get(
    '/address/:address/txs',
  ...
  router.get(
    '/address/:address/orc20-txs/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.orc20TokenTransactions
  )
  router.get(
    '/address/:address/orc20-mempool-txs/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.orc20TokenMempoolTransactions
  )
  router.get(
  ...
  router.get(
    '/address/:address/orc20-balance-history',
    addressMiddleware, paginationMiddleware,
    controller.address.orc20BalanceHistory
  )
  router.get(
    '/address/:address/orc20-balance-history/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.orc20BalanceHistory
  )
  ...
  router.get(
    '/contract/:contract/orc20-balance-history',
    contractMiddleware, paginationMiddleware,
    controller.contract.orc20BalanceHistory
  )
  router.get(
    '/contract/:contract/orc20-balance-history/:token',
  ...
  router.get(
    '/orc20',
    paginationMiddleware,
    controller.orc20.list
  )
  router.get(
    '/orc20/txs',
    paginationMiddleware,
    controller.orc20.allTransactions
  )
  router.get(
    '/orc20/:token/txs',
    middleware.contract('token'), paginationMiddleware, blockFilterMiddleware,
    controller.orc20.transactions
  )
  router.get(
    '/orc20/:token/rich-list',
    middleware.contract('token'), paginationMiddleware,
    controller.orc20.richList
  )
  router.get(
    '/orc721',
    paginationMiddleware,
    controller.orc721.list
  )
